# S0UL-666AX — Build Plan (next agent brief)

**Genre:** action-rpg · **Era inspiration:** 2009 · **Target engine:** three-js
...
(S0UL-666AX). Mechanics are genre conventions; nothing is cloned — no code,
...
3. Depth loop (procedural variety, moddable rules) — modules: StaminaPool, IFrameRules, BossPhaseLoop.
